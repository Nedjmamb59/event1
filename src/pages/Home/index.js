      ...
      <main>
        ...
        <section className="ServicesContainer" id="nos-services">
          ...
          <div className="ListContainer">
            {/* Correction : Le bouton de défilement vers la section "Nos services" ne fonctionnait pas, problème résolu */}
        ...
        <section className="EventsContainer" id="nos-realisations">
          ...
          {/* Correction : Le bouton de défilement vers la section "Nos réalisations" ne fonctionnait pas, problème résolu */}
          <EventList />
        </section>
        <section className="PeoplesContainer" id="notre-equipe">
          ...
          <div className="ListContainer">
            {/* Correction : Le bouton de défilement vers la section "Notre équipe" ne fonctionnait pas, problème résolu */}
            <PeopleCard
